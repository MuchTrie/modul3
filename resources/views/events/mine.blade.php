<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Daftar event yang Anda ajukan</p>
                        </div>
                        <div>
                ...
                <div class="p-6">
                    ...
                    @if($events->count() == 0)
                        <div class="text-center py-16">
                            ...
                            <p class="text-gray-600 mb-6">Anda belum mengajukan event apapun</p>
                            <a href="{{ route('events.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                </svg>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($event->start_at)->format('H:i') }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('events.edit', $event->event_id) }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 mr-3">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                </svg>
                                                Edit
                                            </a>
                                            <form action="{{ route('events.cancel', $event->event_id) }}" method="POST" class="inline" onsubmit="return confirm('Anda yakin ingin membatalkan event ini?');">
                                                @csrf
            ...
            <!-- Back Button -->
            <div class="mt-6">
                <a href="{{ route('panitia.dashboard') }}" class="inline-flex items-center text-gray-600 hover:text-gray-800">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
