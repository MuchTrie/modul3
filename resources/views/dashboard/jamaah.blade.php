...
<head>
    ...
    <title>Dashboard Jamaah - Masjid Al-Nassr</title>
    ...
    <div class="min-h-screen">
        ...
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
                <h1 class="text-2xl font-bold text-gray-900">Dashboard Jamaah</h1>
        ...
        <main class="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div class="bg-white p-6 rounded-lg shadow">
                    <div class="text-gray-500 text-sm mb-2">Event Yang Diikuti</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <a href="{{ route('events.index') }}" class="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-500">Lihat jadwal event</div>
                        </div>
                    </a>
                    ...
                    <a href="#" class="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition">
                        <svg class="w-8 h-8 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <div>
                            <div class="font-semibold">Event Saya</div>
                            <div class="text-sm text-gray-500">Event yang diikuti</div>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <!-- Upcoming Events -->
            <div class="bg-white rounded-lg shadow p-6 mb-8">
                <h2 class="text-xl font-semibold mb-4">Event Mendatang</h2>
                @php
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-l-4 border-blue-500 pl-4 py-2 hover:bg-gray-50">
                            <div class="flex justify-between items-start">
                                ...
                                <a href="{{ route('events.show', $event->event_id) }}" class="text-blue-500 hover:text-blue-700 text-sm">
                                    Lihat Detail →
                                </a>
                            </div>
                        </div>
