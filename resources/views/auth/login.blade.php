    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="bg-gray-200 p-8 text-center">
                ...
                <h1 class="text-xl font-semibold text-gray-800 mb-1">Selamat datang</h1>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <label class="flex items-center text-sm text-gray-600">
                            <input type="checkbox" name="remember" class="rounded border-gray-300 text-gray-600 focus:ring-gray-400 mr-2">
                            Ingat saya
                        </label>
                    ...
                    <div class="text-center text-sm text-gray-600">
                        Tidak Memiliki Akun? 
                        <a href="{{ route('register') }}" class="text-gray-800 hover:text-gray-900 font-medium">
                            Daftar Akun
                        </a>
                    </div>
                </form>
